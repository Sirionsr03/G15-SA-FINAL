...
function CreateProduct() {
  ...
  return (
    <div className='bodycrate'>
      <Flex>
        {contextHolder}
         <div style={{ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "100vh" }}> {/* minHeight: "100vh" */}
          <Card
            style={{
              marginLeft:"0px",
              marginTop:"20px",
            ...
            <Row gutter={[16, 16]} justify="center">
              <Col span={24} style={{ textAlign: "center" }}>
                ...
                >
                  ...
                  />
                  <h2 style={{ margin: "0 180px",fontSize:"25px" }}>สร้างการขายสินค้า</h2>
                  <img
                    src={backarrow}
                    alt="backarrow"
                    onClick={handleBacktoHomeSeller}
